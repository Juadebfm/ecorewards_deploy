 ...
 *         partnerId:
 *           type: string
 *           description: Reference to the partner who owns this QR code
 *         rewardId:
 *           type: string
 *           description: Reference to the reward this QR code represents
 *         qrCode:
 *           type: string
 *           description: Unique QR code identifier (UUID)
 *         batchId:
 *           type: string
 *           description: Batch identifier for bulk QR code generation
 *         scanCount:
 *           type: number
 *           default: 0
 ...
 *           type: number
 *           default: 0
 *           description: Number of unique users who scanned this QR code
 *         successfulClaims:
 *           type: number
 *           default: 0
 *           description: Number of successful reward claims from this QR code
 *         isActive:
 *           type: boolean
 *           default: true
 ...
 *             name:
 *               type: string
 *               description: Location name where QR code is placed
 *             address:
 *               type: string
 *               description: Physical address of QR code location
 *             coordinates:
 *               type: object
 *               properties:
 *                 latitude:
 ...
 *         lastScannedBy:
 *           type: string
 *           description: User ID of last person who scanned
 *         notes:
 *           type: string
 *           description: Admin notes about this QR code
 *         createdAt:
 *           type: string
 *           format: date-time
 ...
 *         qrCode: "qr_a1b2c3d4-e5f6-7890-abcd-ef1234567890"
 *         batchId: "batch_2025_05_26_001"
 *         scanCount: 45
 *         uniqueScans: 38
 *         successfulClaims: 35
 *         location:
 *           name: "GreenTech Store - Downtown"
